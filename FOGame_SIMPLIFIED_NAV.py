...
def render_suggested_players_row(slot: str, suggested_players: pd.DataFrame):
    """
    Render five thin suggested-player cards in one row.

    This version keeps native Streamlit Add buttons so taps update the selected
    roster slot directly, but scopes the column CSS only to this suggestion row.
    That prevents the Team/Position/Salary filters and All Players rows from
    getting stretched or pushed off-screen on mobile.
    """
    ...
    st.markdown(
        ...
        <style>
        /* ============================================================
           THIN SUGGESTED PLAYER CARDS
           Scoped only to the suggestion row marker below.
           ============================================================ */

        div[data-testid="stVerticalBlock"]:has(.suggestion-row-scope) > div[data-testid="stHorizontalBlock"] {
            display: flex !important;
            flex-direction: row !important;
        ...
        div[data-testid="stVerticalBlock"]:has(.suggestion-row-scope) > div[data-testid="stHorizontalBlock"] > div[data-testid="column"] {
        ...
        div[data-testid="stVerticalBlock"]:has(.suggestion-row-scope) .suggest-native-card {
        ...
        div[data-testid="stVerticalBlock"]:has(.suggestion-row-scope) .suggest-pos {
            display: inline-block !important;
            color: #38bdf8 !important;
            border: 1px solid rgba(56,189,248,.55) !important;
        ...
        div[data-testid="stVerticalBlock"]:has(.suggestion-row-scope) .suggest-img-wrap img,
        div[data-testid="stVerticalBlock"]:has(.suggestion-row-scope) .suggest-img-wrap .avatar-circle {
        ...
        div[data-testid="stVerticalBlock"]:has(.suggestion-row-scope) .suggest-name {
            color: #f8fafc !important;
            font-size: 10px !important;
            font-weight: 950 !important;
        ...
        div[data-testid="stVerticalBlock"]:has(.suggestion-row-scope) .suggest-meta {
            color: #94a3b8 !important;
            font-size: 8px !important;
            line-height: 1.1 !important;
        ...
        div[data-testid="stVerticalBlock"]:has(.suggestion-row-scope) .suggest-salary {
            color: #38bdf8 !important;
            font-size: 11px !important;
            line-height: 1.1 !important;
            font-weight: 950 !important;
        ...
        div[data-testid="stVerticalBlock"]:has(.suggestion-row-scope) div[data-testid="stButton"] > button {
        ...
        div[data-testid="stVerticalBlock"]:has(.suggestion-row-scope) div[data-testid="stButton"] > button:hover {
            border-color: rgba(56,189,248,.9) !important;
            background: rgba(14,165,233,.18) !important;
            color: #7dd3fc !important;
        }

        /* iPhone-width tuning: keep all 5 cards visible. */
        @media (max-width: 700px) {
            div[data-testid="stVerticalBlock"]:has(.suggestion-row-scope) > div[data-testid="stHorizontalBlock"] {
                gap: 5px !important;
            }
    ...
    # The marker below lets CSS target only these columns, not every st.columns
    # block inside the dialog.
    with st.container():
        st.markdown('<span class="suggestion-row-scope"></span>', unsafe_allow_html=True)
