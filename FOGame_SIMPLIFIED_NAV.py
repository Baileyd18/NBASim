...
PRESET_ROSTERS = {
    'Current Atlanta': [
        ...
        ('6th Man', 'Gabe Vincent'),
        ('Bench 1', 'Corey Kispert'),
        ('Bench 2', 'Jonathan Kuminga'),
        ('Bench 3', 'Mouhamed Gueye'),
        ('Bench 4', 'Jock Landale'),
        ('Bench 5', 'Zaccharie Risacher'),
        ('Two-Way 1', 'Keaton Wallace'),
        ('Two-Way 2', 'Asa Newell'),
        ('Bench 6', 'Tony Bradley'),
        ('Bench 7', 'Buddy Hield'),
    ],
    'Current Boston': [
        ...
        ('Bench 1', 'Baylor Scheierman'),
        ('Bench 2', 'Jordan Walsh'),
        ('Bench 3', 'Nikola Vucevic'),
        ('Bench 4', 'D. Banton'),
        ('Bench 5', 'Hugo Gonzalez'),
    ...
    'Current Brooklyn': [
        ...
        ('6th Man', 'Ben Saraf'),
        ('Bench 1', 'Terance Mann'),
        ('Bench 2', 'Ziaire Williams'),
        ('Bench 3', 'Danny Wolf'),
        ('Bench 4', "Day'Ron Sharpe"),
        ('Bench 5', 'Nolan Traore'),
        ('Two-Way 1', 'Josh Minott'),
        ('Two-Way 2', 'T. Etienne'),
        ('Bench 6', 'M. Smith'),
        ('Bench 7', 'Jalen Wilson'),
    ],
    'Current Charlotte': [
        ...
        ('Bench 1', 'Josh Green'),
        ('Bench 2', 'Sion James'),
        ('Bench 3', 'Grant Williams'),
        ('Bench 4', 'Ryan Kalkbrenner'),
        ('Bench 5', 'Tre Mann'),
        ('Two-Way 1', 'Tidjane Salaun'),
        ('Two-Way 2', 'X. Tillman'),
        ('Bench 6', 'Liam McNeeley'),
        ('Bench 7', 'P. Hall'),
    ],
    'Current Chicago': [
        ...
        ('6th Man', 'Rob Dillingham'),
        ('Bench 1', 'Collin Sexton'),
        ('Bench 2', 'Leonard Miller'),
        ('Bench 3', 'Patrick Williams'),
        ('Bench 4', 'Z. Collins'),
        ('Bench 5', 'Anfernee Simons'),
    ...
    'Current Cleveland': [
        ...
        ('Bench 1', 'Sam Merrill'),
        ('Bench 2', 'Jaylon Tyson'),
        ('Bench 3', 'Dean Wade'),
        ('Bench 4', 'Craig Porter Jr.'),
        ('Bench 5', 'Keon Ellis'),
        ('Two-Way 1', "Nae'Qwan Tomlin"),
        ('Two-Way 2', 'Thomas Bryant'),
        ('Bench 6', 'Tyrese Proctor'),
        ('Bench 7', 'Larry Nance Jr.'),
    ],
    'Current Dallas': [
        ('Starting PG', 'K. Irving'),
        ('Starting SG', 'Max Christie'),
        ('Starting SF', 'Cooper Flagg'),
        ('Starting PF', 'P.J. Washington'),
        ('Starting C', 'D. Lively II'),
        ('6th Man', 'Brandon Williams'),
        ('Bench 1', 'Naji Marshall'),
        ('Bench 2', 'Klay Thompson'),
        ('Bench 3', 'Khris Middleton'),
        ('Bench 4', 'Daniel Gafford'),
    ...
    'Current Denver': [
        ...
        ('6th Man', 'Bruce Brown'),
        ('Bench 1', 'Tim Hardaway Jr.'),
        ('Bench 2', 'Peyton Watson'),
        ('Bench 3', 'Spencer Jones'),
        ('Bench 4', 'Tyus Jones'),
        ('Bench 5', 'Julian Strawther'),
    ...
    'Current Detroit': [
        ...
        ('6th Man', 'Daniss Jenkins'),
        ('Bench 1', 'Caris LeVert'),
        ('Bench 2', 'Isaiah Stewart'),
        ('Bench 3', 'Marcus Sasser'),
        ('Bench 4', 'Javonte Green'),
        ('Bench 5', 'Paul Reed'),
    ...
    'Current Golden State': [
        ...
        ('6th Man', 'Gary Payton II'),
        ('Bench 1', "De'Anthony Melton"),
        ('Bench 2', 'Al Horford'),
        ('Bench 3', 'Pat Spencer'),
        ('Bench 4', 'Will Richard'),
        ('Bench 5', 'C. Bassey'),
        ('Two-Way 1', 'L. Cryer'),
        ('Two-Way 2', 'M. Leons'),
        ('Bench 6', 'Quinten Post'),
        ('Bench 7', 'N. Williams'),
    ],
    'Current Houston': [
        ...
        ('Bench 1', 'Tari Eason'),
        ('Bench 2', 'Dorian Finney-Smith'),
        ('Bench 3', 'Steven Adams'),
        ('Bench 4', 'Aaron Holiday'),
        ('Bench 5', 'Josh Okogie'),
        ('Two-Way 1', 'J. Tate'),
    ...
    'Current Indiana': [
        ...
        ('6th Man', 'T.J. McConnell'),
        ('Bench 1', 'Ben Sheppard'),
        ('Bench 2', 'Jarace Walker'),
        ('Bench 3', 'Obi Toppin'),
        ('Bench 4', 'Micah Potter'),
        ('Bench 5', 'Johnny Furphy'),
    ...
    'Current LA Clippers': [
        ...
        ('6th Man', 'Jordan Miller'),
        ('Bench 1', 'Bennedict Mathurin'),
        ('Bench 2', 'Kobe Sanders'),
        ('Bench 3', 'John Collins'),
        ('Bench 4', 'Isaiah Jackson'),
        ('Bench 5', 'Nicolas Batum'),
    ...
    'Current LA Lakers': [
        ...
        ('Bench 1', 'Rui Hachimura'),
        ('Bench 2', 'Jarred Vanderbilt'),
        ('Bench 3', 'Jaxson Hayes'),
        ('Bench 4', 'Jake LaRavia'),
        ('Bench 5', 'Maxi Kleber'),
        ('Two-Way 1', 'B. James'),
        ('Two-Way 2', 'A. Thiero'),
        ('Bench 6', 'D. Timme'),
        ('Bench 7', 'Nick Smith Jr.'),
    ],
    'Current Memphis': [
        ...
        ('6th Man', 'S. Pippen Jr.'),
        ('Bench 1', 'T. Jerome'),
        ('Bench 2', 'Kentavious Caldwell-Pope'),
        ('Bench 3', 'Taylor Hendricks'),
        ('Bench 4', 'Olivier-Maxence Prosper'),
        ('Bench 5', 'J. Small'),
        ('Two-Way 1', 'GG Jackson II'),
        ('Two-Way 2', 'Walter Clayton'),
        ('Bench 6', 'Cam Spencer'),
        ('Bench 7', 'Rayan Rupert'),
    ],
    'Current Miami': [
        ...
        ('6th Man', 'Kasparas Jakucionis'),
        ('Bench 1', 'Pelle Larsson'),
        ('Bench 2', 'Jaime Jaquez Jr.'),
        ('Bench 3', 'Simone Fontecchio'),
        ('Bench 4', "Kel'el Ware"),
        ('Bench 5', 'Dru Smith'),
        ('Two-Way 1', 'Nikola Jovic'),
        ('Two-Way 2', 'Keldon Johnson'),
        ('Bench 6', 'M. Gardner'),
        ('Bench 7', 'J. Young'),
    ],
    'Current Milwaukee': [
        ...
        ('6th Man', 'A.J. Green'),
        ('Bench 1', 'Ousmane Dieng'),
        ('Bench 2', 'Bobby Portis'),
        ('Bench 3', 'Jericho Sims'),
        ('Bench 4', 'C. Ryan'),
        ('Bench 5', 'Gary Trent Jr.'),
    ...
    'Current Minnesota': [
        ...
        ('6th Man', 'Mike Conley'),
        ('Bench 1', 'Terrence Shannon Jr.'),
        ('Bench 2', 'Naz Reid'),
        ('Bench 3', 'Bones Hyland'),
        ('Bench 4', 'Jaylen Clark'),
        ('Bench 5', 'Kyle Anderson'),
    ...
    'Current New Orleans': [
        ...
        ('6th Man', 'Jeremiah Fears'),
        ('Bench 1', 'Derik Queen'),
        ('Bench 2', 'Yves Missi'),
        ('Bench 3', 'T. Alexander'),
        ('Bench 4', 'Jordan Hawkins'),
        ('Bench 5', 'Micah Peavy'),
        ('Two-Way 1', 'Karlo Matkovic'),
        ('Two-Way 2', 'Jordan Poole'),
        ('Bench 6', 'Bryce McGowens'),
        ('Bench 7', 'Kevon Looney'),
    ],
    'Current New York': [
        ...
        ('Bench 1', 'Landry Shamet'),
        ('Bench 2', 'Jordan Clarkson'),
        ('Bench 3', 'Mitchell Robinson'),
        ('Bench 4', 'Jose Alvarado'),
        ('Bench 5', 'M. Diawara'),
        ('Two-Way 1', 'A. Hukporti'),
        ('Two-Way 2', 'Tyler Kolek'),
        ('Bench 6', 'Jeremy Sochan'),
        ('Bench 7', 'P. Dadiet'),
    ],
    'Current Oklahoma City': [
        ...
        ('6th Man', 'Ajay Mitchell'),
        ('Bench 1', 'Jared McCain'),
        ('Bench 2', 'Cason Wallace'),
        ('Bench 3', 'Alex Caruso'),
        ('Bench 4', 'Kenrich Williams'),
        ('Bench 5', 'T. Sorber'),
    ...
    'Current Orlando': [
        ...
        ('Bench 1', 'Jared McCain'),
        ('Bench 2', 'Tristan Da Silva'),
        ('Bench 3', 'Goga Bitadze'),
        ('Bench 4', 'Jevon Carter'),
        ('Bench 5', 'Jett Howard'),
        ('Two-Way 1', 'Jonathan Isaac'),
        ('Two-Way 2', 'Moritz Wagner'),
        ('Bench 6', 'Jase Richardson'),
        ('Bench 7', 'Noah Penda'),
    ],
    'Current Philadelphia': [
        ...
        ('6th Man', 'Quentin Grimes'),
        ('Bench 1', 'Dominick Barlow'),
        ('Bench 2', 'Andre Drummond'),
        ('Bench 3', 'Justin Edwards'),
        ('Bench 4', 'Adem Bona'),
        ('Bench 5', 'K. Lowry'),
        ('Two-Way 1', 'Dalen Terry'),
        ('Two-Way 2', 'Jabari Walker'),
        ('Bench 6', 'Trendon Watford'),
        ('Bench 7', 'Tyrese Martin'),
    ],
    'Current Phoenix': [
        ...
        ('6th Man', 'Collin Gillespie'),
        ('Bench 1', 'Grayson Allen'),
        ('Bench 2', "Royce O'Neale"),
        ('Bench 3', 'Oso Ighodaro'),
        ('Bench 4', 'J. Bouyea'),
        ('Bench 5', 'H. Highsmith'),
        ('Two-Way 1', 'Ryan Dunn'),
        ('Two-Way 2', 'K. Maluach'),
        ('Bench 6', 'Rasheer Fleming'),
        ('Bench 7', 'Amir Coffey'),
    ],
    'Current Portland': [
        ...
        ('6th Man', 'Shaedon Sharpe'),
        ('Bench 1', 'Matisse Thybulle'),
        ('Bench 2', 'Jerami Grant'),
        ('Bench 3', 'Robert Williams'),
        ('Bench 4', 'Kris Murray'),
        ('Bench 5', 'Sidy Cissoko'),
    ...
    'Current Sacramento': [
        ...
        ('6th Man', 'Malik Monk'),
        ('Bench 1', 'Nique Clifford'),
        ('Bench 2', "De'Andre Hunter"),
        ('Bench 3', 'Precious Achiuwa'),
        ('Bench 4', 'Maxime Raynaud'),
        ('Bench 5', 'Devin Carter'),
        ('Two-Way 1', 'D. Cardwell'),
        ('Two-Way 2', 'Killian Hayes'),
        ('Bench 6', 'D. Plowden'),
        ('Bench 7', 'Drew Eubanks'),
    ],
    'Current San Antonio': [
        ...
        ('6th Man', 'Dylan Harper'),
        ('Bench 1', 'Keldon Johnson'),
        ('Bench 2', 'Carter Bryant'),
        ('Bench 3', 'Harrison Barnes'),
        ('Bench 4', 'Luke Kornet'),
    ...
    'Current Toronto': [
        ...
        ('6th Man', 'Jamal Shead'),
        ('Bench 1', "Ja'Kobe Walter"),
        ('Bench 2', 'J. Battle'),
        ('Bench 3', 'Collin Murray-Boyles'),
        ('Bench 4', 'Sandro Mamukelashvili'),
        ('Bench 5', 'A. Lawson'),
        ('Two-Way 1', 'Gradey Dick'),
        ('Two-Way 2', 'J. Mogbo'),
        ('Bench 6', 'Trayce Jackson-Davis'),
        ('Bench 7', 'C. Hepburn'),
    ],
    'Current Utah': [
        ...
        ('6th Man', 'Isaiah Collier'),
        ('Bench 1', 'Cody Williams'),
        ('Bench 2', 'Brice Sensabaugh'),
        ('Bench 3', 'Kyle Filipowski'),
        ('Bench 4', 'Jusuf Nurkic'),
        ('Bench 5', 'E. Harkless'),
    ...
    'Current Washington': [
        ...
        ('6th Man', 'Bub Carrington'),
        ('Bench 1', 'Tre Johnson'),
        ('Bench 2', 'Will Riley'),
        ('Bench 3', 'Justin Champagnie'),
        ('Bench 4', 'T. Vukcevic'),
        ('Bench 5', 'S. Cooper'),
        ('Two-Way 1', 'Jaden Hardy'),
        ('Two-Way 2', 'Cam Whitmore'),
        ('Bench 6', "D'Angelo Russell"),
        ('Bench 7', 'J. Watkins'),
    ],
}
...
if _logo_b64:
        ...
        <div class="hero-wrap">
            <div class="hero-grid">
                ...
                <div>
                    ...
                    <div class="sub-title">Build, score, and analyze a custom NBA roster in a cleaner step-by-step layout.</div>
                </div>
            </div>
        </div>
        """,
    ...
    st.markdown('<div class="sub-title">Build, score, and analyze a custom NBA roster.</div>', unsafe_allow_html=True)

api_key_loaded = bool(OPENAI_API_KEY.strip()) and OPENAI_API_KEY.strip() != PLACEHOLDER_API_KEY
if api_key_loaded:
    st.success("OpenAI API key loaded. AI scouting reports are enabled.")
else:
    st.info("No OpenAI API key detected. The app will use the built-in fallback report.")
...
with s1:
    st.metric("Roster", f"{len(roster_rows)}/{st.session_state.roster_size}")
with s2:
    st.metric("Payroll", money(payroll))
with s3:
    st.metric("Remaining", money(remaining))
with s4:
    st.metric("Cap Level", money(salary_cap))

st.progress(min(payroll / salary_cap, 1.0) if salary_cap else 0)
if payroll > salary_cap:
    st.error("Roster is over the selected cap level. Results can still be generated, but cap penalties may apply.")
...
setup_tab, draft_tab, roster_tab, results_tab = st.tabs([
    "1. Setup",
    "2. Draft Players",
    "3. Roster",
    "4. Results"
...
with setup_tab:
    ...
    with col1:
        ...
        if new_roster_size != st.session_state.roster_size:
            ...
            active_slots = ROSTER_SLOTS[:new_roster_size]
    ...
    with col2:
        ...
        st.caption(f"Active cap: {money(salary_cap)}")

    st.divider()

    preset_choice = st.selectbox(
        "Load Preset Current Roster",
    ...
    st.info("Use this tab only for roster size, salary level, and presets. Drafting is handled in the next tab.")
...
with draft_tab:
    st.markdown('<div class="section-title">Draft Players</div>', unsafe_allow_html=True)

    f1, f2, f3, f4 = st.columns([1.4, 1, 1, 1])
    with f1:
        search = st.text_input("Search Player", placeholder="Example: Shai, Luka, Bam")
    with f2:
        selected_team = st.selectbox("Team", ["All"] + sorted(df["Team"].unique().tolist()))
    with f3:
        selected_position = st.selectbox("Listed Position", ["All"] + sorted(df["Pos"].unique().tolist()))
    with f4:
        sort_label = st.selectbox("Sort By", ["PPG", "APG", "RPG", "BPM", "Impact", "Salary"], index=0)
    ...
    ].sort_values(SORT_MAP[sort_label], ascending=False)

    open_slots = [slot for slot in active_roster_slots if slot not in st.session_state.roster]

    if len(open_slots) == 0:
        st.success("Roster is full. Go to Results to score the team.")
        ...
        with d1:
            player_options = player_pool["Player"].head(250).tolist()
            selected_player_name = st.selectbox(
                "Player",
                player_options,
                key=f"simple_player_select_{st.session_state.player_select_reset}"
            )

        with d2:
            selected_slot = st.selectbox("Roster Slot", open_slots)

        selected_player_row = player_pool[player_pool["Player"] == selected_player_name].iloc[0]

        st.markdown(
            f"""
            <div class="metric-card">
                <div class="metric-label">Selected Player</div>
                <div class="metric-value" style="font-size:20px;">{selected_player_row['Player']}</div>
                <div class="roster-detail">
                    {selected_player_row['Team']} | {selected_player_row['Pos']} | {money(selected_player_row['Salary'])}<br>
                    {selected_player_row['PTS']:.1f} PPG | {selected_player_row['AST']:.1f} APG | {selected_player_row['TRB']:.1f} RPG | {selected_player_row['BPM']:.1f} BPM
                </div>
            </div>
            """,
            unsafe_allow_html=True
        ...
        if st.button("Add Player to Roster", type="primary", use_container_width=True):
            add_player_to_slot(selected_player_row, selected_slot)
            st.session_state.player_select_reset += 1
            st.rerun()

    st.divider()
    st.caption("Top available players based on your filters:")
    board_cols = ["Player", "Team", "Pos", "Salary Display", "PPG", "APG", "RPG", "BPM", "Impact_Score"]
    st.dataframe(player_pool[board_cols].head(25), use_container_width=True, height=360)
...
with roster_tab:
    ...
    st.dataframe(roster_dataframe_for_display(), use_container_width=True, height=430)

    st.divider()
    st.subheader("Remove Player")

    filled_slots = [slot for slot in active_roster_slots if slot in st.session_state.roster]
    if not filled_slots:
        ...
        remove_slot = st.selectbox(
            "Choose Slot",
            filled_slots,
            format_func=lambda s: f"{s} — {st.session_state.roster[s]['Player']}"
        )
        if st.button("Remove Selected Player", type="secondary", use_container_width=True):
            remove_player_from_slot(remove_slot)
            st.rerun()
...
with results_tab:
    ...
    if len(st.session_state.roster) < MIN_RESULTS_PLAYERS:
        ...
        for slot in active_roster_slots:
            if slot in st.session_state.roster:
                roster_df.loc[
                    roster_df["Player"] == st.session_state.roster[slot]["Player"],
                    "Slot"
                ] = slot

        metrics = calculate_team_metrics(roster_df, st.session_state.active_salary_cap)
        roster_fit_df = metrics["roster_with_fit"]
        team_summary = build_team_summary(roster_df, metrics)

        r1, r2, r3, r4 = st.columns(4)
        with r1:
            st.metric("Draft Grade", metrics["grade"])
        with r2:
            st.metric("Projected Wins", metrics["projected_wins"])
        with r3:
            st.metric("Overall Score", metrics["overall_score"])
        with r4:
            st.metric("Identity", metrics["identity"])
        ...
        grade_df = pd.DataFrame({
            "Category": [
                ...
                "Star Power", "Talent", "Depth", "Fit", "Versatility", "Cumulative BPM"
            ],
            "Score": [
                ...
                metrics.get("cumulative_bpm_score", 0)
            ]
        })
        st.bar_chart(grade_df.set_index("Category"))

        with st.expander("Player Role & Fit Breakdown", expanded=False):
            role_data = []
            for _, row in roster_fit_df.iterrows():
                role_data.append({
                    "Slot": row["Slot"],
